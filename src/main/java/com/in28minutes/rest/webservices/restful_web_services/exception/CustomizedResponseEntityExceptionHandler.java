...
//gievn this anno to classes using @ExceptionHandler.....
//it is also a specialization of @Component like @Controller or @Service....
@ControllerAdvice
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	
	//handling retrieveUser() when there is server issue
	...
	//This method is used for giving validation error to user as a json object when new user added using post mapping.....
	@Override
